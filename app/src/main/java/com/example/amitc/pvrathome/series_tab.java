...
public class series_tab extends AppCompatActivity {
        ...
        postBackground.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, MainActivity.class));
                    }
        ...
        postBackground1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, movies_tab.class));
                    }
                }, 100); //delay 100 milliseconds to see the effect.
            }
        });
        ...
        postBackground3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, specials_tab.class));
                    }
                }, 100); //delay 100 milliseconds to see the effect.
            }
        });
        ...
        postBackground4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, music_tab.class));
                    }
                }, 100); //delay 100 milliseconds to see the effect.
            }
        });
        ...
        postBackground5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, favorite_tab.class));
                    }
                }, 100); //delay 100 milliseconds to see the effect.
            }
        });
        ...
        Drawable image6; //this could be any image of your choice
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(series_tab.this, downloaded_tab.class));
                    }
                }, 100); //delay 100 milliseconds to see the effect.
            }
        });
        ...
        else
    {
        ...
        ImageView btn1 = (ImageView)findViewById(R.id.actors_button);
